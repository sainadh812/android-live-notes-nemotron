...
| ONNX Runtime (CPU DLL) | [Microsoft ONNX Runtime](https://github.com/microsoft/onnxruntime/tree/v1.23.2), MIT; upstream dependency notices are bundled in `licenses/onnxruntime-ThirdPartyNotices.txt` |
